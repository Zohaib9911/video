...
export function JoiningScreen({
  ...
  async function requestAudioVideoPermission(mediaType) {
    try {
      ...
      // Do not auto-enable mic or webcam on permission grant. User will toggle explicitly.
    } catch (ex) {
  ...
  const checkMediaPermission = async () => {
    ...
    // Do not auto-enable mic/webcam on initial load even if permissions are granted.
